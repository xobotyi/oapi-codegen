...
directory does a lot of that for you. You would run it like so:
    ...
    go install github.com/xobotyi/oapi-codegen/cmd/oapi-codegen@latest
...
import (
	...
	"github.com/xobotyi/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/xobotyi/oapi-codegen/pkg/gin-middleware"
)
...
```go
    import (
        "github.com/xobotyi/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/xobotyi/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
output-options:
  skip-prune: true
import-mapping:
  ./packageA/spec.yaml: github.com/xobotyi/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/xobotyi/oapi-codegen/internal/test/externalref/packageB
output: externalref.gen.go
output-options:
  skip-prune: true
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/xobotyi/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48) 
